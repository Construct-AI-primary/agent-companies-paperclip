...
-- ============================================================
-- NOTE: Always cast UUID to TEXT for cross-table comparisons
BEGIN;
...
DELETE FROM agent_config_revisions WHERE agent_id::text IN (SELECT id::text FROM agents);

-- 7. Delete agent API keys
DELETE FROM agent_api_keys WHERE agent_id::text IN (SELECT id::text FROM agents);

-- 8. Clear self-referential nullable FK (set to NULL before deleting parent)
DO $$ BEGIN
    UPDATE agents SET reports_to = NULL WHERE reports_to::text IN (SELECT id::text FROM agents);
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-seostrategist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-linkbuilder');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-performanceoptimizer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-blogarchitect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-technicalseo');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-reportingspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-contentmaestro');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-dataanalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-localseoexpert');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-seoanalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-conversionspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-mobileoptimizer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-conversionanalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-emailcomposer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-communicationorchestr');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-uxdesigner');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contentforge-ai-socialstrategist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'ally-devforge-partnership-management');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'interface-devforge-api-integration');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'vector-Vector-processing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voyager-devforge-market-exploration');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'librarian-devforge-knowledge-management');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'fixer-devforge-bug-fixing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'forge-devforge-system-architecture');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'nexus-devforge-ceo');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'devforge-ai-multidisciplinecoord');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'synth-Synthetic-data');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'devforge-ai-documentgenerationsp');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'archivist-devforge-knowledge-security');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'insight-devforge-business-intelligence');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'sentinel-devforge-data-quality-monitoring');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'merchant-devforge-commerce-operations');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'devcore-devforge-core-development');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'devforge-ai-financialvalidator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'cloudops-devforge-cloud-operations');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'concierge-devforge-customer-experience');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'sentinelx-devforge-advanced-monitoring');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'sql-query-devforge');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'schema-devforge-data-schema-management');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'council-devforge-strategic-decision-making');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mentor-devforge-team-development');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'dealmaker-devforge-sales-negotiation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'devforge-ai-workflowlearningcoor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'atlas-devforge-product-mapping');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'strategos-devforge-strategic-planning');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'guardian-devforge-threat-protection');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'amplifier-devforge-marketing-promotion');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'nova-devforge-product-launches');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'analyst-devforge-market-analysis');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'brandforge-devforge-brand-development');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'pathfinder-devforge-opportunity-identification');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'catalyst-devforge-product-innovation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'codesmith-devforge-backend-engineer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'automata-devforge-automation-systems');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'storycraft-devforge-product-storytelling');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'promptsmith-devforge-prompt-engineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'compass-devforge-direction-setting');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'navigator-devforge-data-discovery');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'reviewer-devforge-code-review-qa');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'ambassador-devforge-brand-representation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'gatekeeper-devforge-access-control');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'devforge-ai-transactionprocessor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'devforge-ai-workflowcomplexityan');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'watchtower-devforge-security-oversight');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'oracle-devforge-predictive-analytics');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'auditor-devforge-security-compliance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'stream-devforge-data-streaming');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'dataforge-devforge-data-transformation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'catalystx-devforge-market-disruption');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'scout-devforge-competitive-intelligence');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'cartographer-devforge-product-roadmapping');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'ledgerai-devforge-financial-data');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'pulse-devforge-realtime-monitoring');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'orion-devforge-orchestrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'ledger-devforge-financial-oversight');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'cortex-devforge-ai-reasoning');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-constructiondirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'procurement-domainforge-procurement-contracts');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'council-domainforge-governance-standards');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'strategos-domainforge-strategic-planning');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-publicrelations');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-design');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-financialcompliance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contract-administration-domainforge-contract-administration');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-salesdirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-security');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-localcontent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-environmental');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'orion-domainforge-ceo');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-landscaping');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-counselspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'procurement-strategy-domainforge-procurement-strategy');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-otherparties');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'structural-domainforge-structural-engineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-hsedirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-mobileworkflowdesign');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'finance-domainforge-finance-cost-management');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'civil-domainforge-civil-engineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-sales');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-buyerspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-contractsdirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-projectcontrols');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-inspection');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'safety-domainforge-safety-risk-management');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-sundry');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-health');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-transportation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'quality-assurance-domainforge-quality-assurance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'quality-control-domainforge-quality-control');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'procurement-analytics-domainforge-procurement-analytics');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-evaluator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-engineeringdirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-chemicalengineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-architecturalintegrat');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-contractspreaward');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-guardian2');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-logisticsdirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-processengineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'logistics-domainforge-supply-chain');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-financedirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-ethics');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-inspectorspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-directors');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-scrutineer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-contractspostaward');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'construction-engineering-domainforge-construction-engineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-commercial');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-treasurer2');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'legal-domainforge-legal-regulatory-compliance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-mobiletesting');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-dispatcherspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-mechanicalengineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'geotechnical-domainforge-geotechnical-engineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-directorproject');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-architectural');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-documentcontrol');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-electricalengineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-informationtechnology');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-suppliermanagement');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-quantitysurveying');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-scheduling');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'domainforge-ai-procurementdirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-taskcoordinator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-securityspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'maya-loopy-content-strategist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'vision-loopy-ceo');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-presentationspecialis');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-intelligenceanalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-systemsintegrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-datamanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-performanceanalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-automationengineer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-communicationsmanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-knowledgecurator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-strategicadvisor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-researchassistant');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-workflowoptimizer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-scheduler');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-personalassistant');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'execforge-ai-chiefofstaff');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'infraforge-ai-nimbussupabase');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'render-deployment-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'database-infraforge-database-infrastructure');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'orchestrator-infraforge-ceo');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'supply-chain-integration-infraforge-supply-chain');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'postgres-infraforge');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobile-api-infraforge-mobile-api-integration');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-cococandy');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-hazelhecras');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-astroasta');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-wileyprojectwise');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-aceaconex');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-terracivil3d');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-novanavisworks');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-stormswmm');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-blakebuildsoft');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-elietabs');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-rexrevit');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-sashasharepoint');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-phoenixp6');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-stanstaad');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-coreyprocore');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-cashcostx');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-adaautocad');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-pixelbim360');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-ziggyorchestrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-trixtrimble');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrateforge-ai-maxmsproject');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-directors');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-administrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-generalist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-negotiator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-sentinel');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-physician');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-constructor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-geologist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-controller');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-designer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-salesperson');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-technician');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-chemist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-guardian');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-builder');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-merchant');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-inetrmediary');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-leader');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-engineer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-communicator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-treasurer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-environmentalist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-counsel');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-buyer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-scheduler');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-examiner');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-ethicist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-landscaper');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-greeter');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-chairman');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-critic');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-concierge');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-governor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-optimizer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-ambiguityprime');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-gatekeeper');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-inspector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-archivist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-surveyor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-developer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-electrician');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-dispatcher');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'knowledgeforge-ai-coordinator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Architect - refactor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'User Manager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Development Manager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Communication Manager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Director Project');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Director HSE');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Director Sales');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Director Procurement');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'System Administrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'AI Manager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Monitor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Operations Coordinator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Director Logistics');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Investigator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Integrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Architect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Director Engineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Analyst Sector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Director Projects');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Director Construction');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Quality Assurance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Administrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Inspector QC');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'KnowledgeForge Workflow Guardian');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Docs Analyzer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Advisor Disciplines');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Validator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Interface Specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'Administrator - pre-award');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-assessment-mastery');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-error-pattern-monitor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-user-behavior-analyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-research-compliance-division-lead');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-equipment-inspection');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-autoresearch-gap-analyzer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-doc-usage-analyzer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-safetyresearchagent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-electrical-engineering-agent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-hazard-pattern-analyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-knowledge-provenance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-from-doc-to-lesson-generator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-interaction-pattern-coach');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-vfs-watcher');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-quality-learning');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-compliance-guard');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-research-scheduler');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-safety-regulation-research');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-mobilepatternsagent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-learningintegration');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-material-defect-tracker');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-safety-training-compliance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-procurement-agent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-safety-workflow-agent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-doc-gap-detector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-hermes-research');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-equipment-innovation-research');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-learning-division-lead');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-goal-alignment-budget');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-knowledge-hygiene');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-audit-by-path');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-langchain-runner');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-defect-pattern-research');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-safety-quality-division-lead');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-logistics-agent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-feedback-synthesis');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-workflow-coach');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-autoresearch-skills-enhancer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-knowledge-flow-division-lead');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-autoresearch-literature-scanner');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-vfs-markdown-tracker');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-priority-disciplines-lead');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-curriculum-planner');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-micro-lesson-generator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-audit-explainability');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-knowledge-flow-agent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-field-safety-inspector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-construction-law-research');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-ceo');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-knowledge-transparency');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'learningforge-ai-contracts-agent');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'jordan-loopy-marketing-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'alex-loopy-deep-research');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'sam-loopy-social-media-coordinator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'dev-loopy-technical-creative');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'measurement-validation-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'visual-overlay-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'measureforge-ai-electrical-qa-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'sans-standards-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'asaqs-standards-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contract-tender-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'order-generation-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'measureforge-ai-electrical-measurement-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'contour-analysis-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mep-element-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'measureforge-ai-traffic-signal-compliance-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'measureforge-ai-traffic-signal-measurement-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'architectural-element-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'measureforge-ai-electrical-compliance-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'cost-estimation-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'structural-element-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'quantity-surveyor-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'earthwork-calculation-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'autocad-integration-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'measurement-coordination-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'cad-measurement-orchestrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-uiuxspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-appmanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-cloudconnector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-apispecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-performanceoptimizer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-devicecontroller');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-mobilemaestro');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-mobiledeveloper');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-testingcoordinator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'mobileforge-ai-securityguardian');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-dataintegrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-issuegenerator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-monitormaven');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-operationsdirector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-assignmentspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-databasecrudorchestrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-measurementvalidation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-engineeringuispecial');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-configcurator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-bridgebuilderextraor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-documentarian');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-measurementcoordspec');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-apimanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-tickettinkerer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-githuboperationsspec');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-resourcemanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-wisdomweaver');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-networknavigator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-qualitycontroller');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-agent-reconciler');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-workflowautomator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-databasedruid');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-orgresearchfoldercr');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-advancedengineering');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-integrationarchitect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-dataarchitect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'issue-batch-importer-paperclipforge');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-tasktangodancer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-testcommander');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-codesage');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-projectcoordinator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-loganalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-measurementstandards');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-crossdisciplinecoord');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-performanceprofiler');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-modelassignmentspeci');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-endpointenchantress');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-performancemonitor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-atlasagentcreator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-projectmaestro');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-knowledgeintegrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-cachekeeper');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-integrationillusionis');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-reportinganalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-deployer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-userexperiencecoordi');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-chainlinkcharmer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-progresstracker');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-predictivemodeler');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-riskanalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-securityguardian');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-authadministrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'paperclipforge-ai-dependencymanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'tuner-promptforge-ab-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'cascade-promptforge-workflow-designer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'quantifier-promptforge-benchmarking');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'analyzer-promptforge-prompt-analytics');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'compliance-promptforge-regulatory-compliance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'scholar-promptforge-academic-research');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'validator-promptforge-syntax-logic-validation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integration-promptforge-cross-agent-compatibility');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'sage-promptforge-chief-architect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'archivist-promptforge-knowledge-management');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'flowdesigner-promptforge-agent-handoff');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'promptforge-ai-disciplineautomation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'predictor-promptforge-outcome-prediction');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'enhancer-promptforge-advanced-innovation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'statemaster-promptforge-state-management');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'blueprint-promptforge-template-designer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'refiner-promptforge-version-control');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'explorer-promptforge-new-techniques');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'experimenter-promptforge-hypothesis-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'harmonic-promptforge-orchestration-strategy');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'collaborator-promptforge-cross-company-knowledge-sharing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'clarity-promptforge-performance-optimization');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrity-promptforge-ethical-ai');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'specialist-promptforge-domain-adaptation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'monitor-qualityforge-quality-monitor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'tracer-qualityforge-execution-tracer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integrator-Integration-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'guardian-qualityforge-quality-guardian');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'integration-Integration-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'profiler-Performance-profiler');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'apex-qualityforge-ceo');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'resolver-qualityforge-issue-resolver');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'fixer-qualityforge-bug-fixing-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'refactor-Refactoring-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'loadtester-qualityforge-scalability-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'coverage-qualityforge-test-coverage-analyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'qualityforge-ai-compliancevalidator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'dbat-testing-qualityforge');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'maintainer-qualityforge-code-maintainer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'compatibility');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'documenter-qualityforge-documentation-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'code-analyzer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'validator-Validator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'debugger-Debugger-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'inspector-qualityforge-code-inspector');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'optimizer-qualityforge-code-optimizer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'qualityforge-ai-documentationprocess');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'performance-Performance-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'accessibility-Accessibility-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'qualityforge-ai-decisionsupport');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'reporter-qualityforge-quality-reporter');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'load-Load-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'qualityforge-ai-assessmentcriteria');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'standards-Standards-enforcer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'reviewer-qualityforge-code-reviewer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'auditor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'automation-qualityforge-test-automation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'e2e-qualityforge-end-to-end-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'probe-qualityforge-prompt-testing');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'codesmith-qualityforge-code-architect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'migrator-qualityforge-migration-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'simulator-qualityforge-workflow-simulation');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'trainer-qualityforge-quality-trainer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'architect-qualityforge-system-architect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'diagnostics-Diagnostics-specialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'governor-qualityforge-quality-director');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-successmanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-clientconfigmanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-renderservicemanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-onboardmaster');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-dataguardian');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-githubbranchmanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-accesscontroller');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-onboardingcoordinator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-supportintegrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-securityspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-analyticsspecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-tenantmanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-devopsengineer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-resourceoptimizer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-deploymentorchestrato');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'saasforge-ai-platformarchitect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-contextcoordinator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-intentanalyst');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-personalitydesigner');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-platformintegrator');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-speechprocessor');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-languagespecialist');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-audioengineer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-qualityassurance');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-conversationmanager');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-apiarchitect');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-voicesynthesizer');
...
SELECT 
    ...
    NOW()
WHERE EXISTS (SELECT 1 FROM agents WHERE title = 'voiceforge-ai-voicemaestro');
