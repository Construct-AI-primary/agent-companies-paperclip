---
title: "02400 Safety — Desktop UI/UX Specification"
description: "Desktop UI/UX specification for the 02400 Safety discipline page covering contractor safety management, incident reporting, compliance monitoring, HITL review, and AI model backend"
...
platform: "desktop"
viewport: "1280px+"
gigabrain_tags: safety, ui-ux, specification, desktop, contractor-safety, compliance, incident-reporting, hitl-review
related_docs:
...
# 02400 Safety — Desktop UI/UX Specification

> **Platform**: Desktop (1280px+)
> **Parent Index**: [ui-ux/index.md](./index.md)
