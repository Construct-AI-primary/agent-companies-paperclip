---
title: "01900 Procurement — Desktop UI/UX Specification"
description: "Desktop UI/UX specification for the 01900 Procurement discipline page — Template A foundation reference with three-state navigation, procurement workflows, supplier management, and AI model backend"
...
platform: desktop
viewport: "1280px+"
tags: procurement, ui-ux, desktop, specification, template-a, foundation-reference, supplier-management, tender, three-state
...
# 01900 Procurement — Desktop UI/UX Specification
...
**Background Image**: The 01900 page uses a background image, which is the standard for most Template A pages. Per `0000_VISUAL_DESIGN_STANDARDS.md`, only 00106 timesheet does NOT use a background image — all other pages should use background images.
