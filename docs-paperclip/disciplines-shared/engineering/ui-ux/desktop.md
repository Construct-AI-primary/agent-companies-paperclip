---
title: "Cross-Discipline Engineering Platform — UI/UX Specification (Desktop)"
description: "Desktop-specific UI/UX specification for the shared engineering platform — full specification covering 10 engineering disciplines, shared components, three-state navigation, and AI model backend"
author: "PaperclipForge AI — UI/UX Design Coordination"
date: "2026-04-28"
version: "1.0"
status: "active"
gigabrain_tags: engineering, ui-ux, specification, desktop, cross-discipline, platform-architecture, shared-components
platform: desktop
viewport: "1280px+"
related_docs:
...
# Cross-Discipline Engineering Platform — UI/UX Specification (Desktop)

> **Viewport**: 1280px+
> **Primary platform**: Desktop — full three-state navigation, side-by-side layouts, multi-column grids
...
### 20. Desktop Layout Specifications
