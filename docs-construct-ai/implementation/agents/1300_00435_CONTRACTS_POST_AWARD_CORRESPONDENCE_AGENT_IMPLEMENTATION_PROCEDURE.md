...
The 7-agent orchestration system uses standardized database keys for prompt retrieval following the hierarchical naming convention:

```
agent_correspondence_{agent_id}_{purpose}
```

1. **Document Analysis Agent** (`correspondence-01`): `agent_correspondence_01_document_analysis`
2. **Information Extraction Agent** (`correspondence-02`): `agent_correspondence_02_identifier_extraction`
3. **Document Retrieval Agent** (`correspondence-03`): `agent_correspondence_03_document_retrieval`
4. **Domain Specialist Agent** (`correspondence-04`): `agent_correspondence_04_domain_specialist`
5. **Contract Management Agent** (`correspondence-05`): `agent_correspondence_05_contract_management`
6. **Human Review Agent** (`correspondence-06`): `agent_correspondence_06_human_review`
7. **Professional Formatting Agent** (`correspondence-07`): `agent_correspondence_07_professional_formatting`
