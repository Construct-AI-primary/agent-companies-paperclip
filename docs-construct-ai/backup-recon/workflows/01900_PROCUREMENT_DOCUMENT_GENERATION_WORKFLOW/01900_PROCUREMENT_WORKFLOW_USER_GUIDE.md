...
The procurement workflow integrates **4 core systems** accessible via dedicated URLs:
...
- **Purpose**: Create and manage PO/WO/SO procurement orders
...
```javascript
// Procurement Order Creation Flow
{
