...
flowchart TD
    ...
    subgraph "Step 6: Human Review (HITL)"
        A6[Human Review Agent<br/>Creates HITL tasks for complex cases<br/>and quality assurance]
    end
...
- **HITL Integration**: Human-in-the-loop validation
...
```
Correspondence → 7 Agents → 17 Specialists → HITL → Professional Response
     ↓              ↓              ↓              ↓              ↓
Analysis     Sequential    Parallel      Human       Formal
Processing   Processing    Processing   Validation   Generation
```
