...
-- Generated: 2026-01-07T04:37:24.962Z
-- Total Tables: 445
...
-- Table: a_00105_travel_vector
CREATE TABLE IF NOT EXISTS public.a_00105_travel_vector (
    id TEXT,
    embedding TEXT,
    metadata unknown,
    content TEXT,
    ...
    access_scope TEXT,
    organisation_id INTEGER,
    shared_with_disciplines unknown
);

-- Table: a_00106_timesheet_vector
CREATE TABLE IF NOT EXISTS public.a_00106_timesheet_vector (
    id TEXT,
    embedding TEXT,
    metadata unknown,
    content TEXT,
...
-- Table: a_00425_contracts_pre_vector
CREATE TABLE IF NOT EXISTS public.a_00425_contracts_pre_vector (
    id TEXT,
    embedding TEXT,
    metadata unknown,
    content TEXT,
...
-- Table: a_00871_processeng_vector
CREATE TABLE IF NOT EXISTS public.a_00871_processeng_vector (
    id TEXT,
    embedding TEXT,
    metadata unknown,
    content TEXT,
...
-- Table: a_00889_dirfinance_vector
CREATE TABLE IF NOT EXISTS public.a_00889_dirfinance_vector (
    id TEXT,
    embedding TEXT,
    metadata unknown,
    content TEXT,
...
-- Table: a_02000_projctrl_vector
CREATE TABLE IF NOT EXISTS public.a_02000_projctrl_vector (
    id TEXT,
    embedding TEXT,
    metadata unknown,
    content TEXT,
...
-- Table: field_attribute_compliance
CREATE TABLE IF NOT EXISTS public.field_attribute_compliance (
    id TEXT NOT NULL,
    template_id TEXT,
...
-- Table: logistics_approval_steps
CREATE TABLE IF NOT EXISTS public.logistics_approval_steps (
    id TEXT NOT NULL,
    workflow_id TEXT,
    step_number INTEGER NOT NULL,
...
-- Table: logistics_approval_workflows
CREATE TABLE IF NOT EXISTS public.logistics_approval_workflows (
    id TEXT NOT NULL,
    document_id TEXT,
...
-- Table: logistics_context_data
CREATE TABLE IF NOT EXISTS public.logistics_context_data (
    id TEXT NOT NULL,
    procurement_order_id TEXT,
    orderid TEXT,
    ordernumber TEXT,
    orderdate TEXT,
    exporterdetails unknown,
    importerdetails unknown,
...
-- Table: logistics_coordination_monitor
CREATE TABLE IF NOT EXISTS public.logistics_coordination_monitor (
    task_id TEXT,
    title TEXT,
    task_status TEXT,
    priority TEXT,
    assigned_to_discipline TEXT,
    procurement_order_id TEXT,
    procurement_description TEXT,
    documents_generated INTEGER,
    last_document_generated TEXT,
    total_messages INTEGER,
    last_message_date TEXT
);

-- Table: logistics_document_versions
CREATE TABLE IF NOT EXISTS public.logistics_document_versions (
    id TEXT NOT NULL,
    document_id TEXT,
    version_number INTEGER NOT NULL,
    content unknown,
...
-- Table: order_derived_template_usage
CREATE TABLE IF NOT EXISTS public.order_derived_template_usage (
    id TEXT NOT NULL,
    template_id TEXT,
    order_id TEXT,
    user_id TEXT,
...
-- Table: template_derivations
CREATE TABLE IF NOT EXISTS public.template_derivations (
    id TEXT NOT NULL,
    parent_template_id TEXT,
    derived_template_id TEXT,
