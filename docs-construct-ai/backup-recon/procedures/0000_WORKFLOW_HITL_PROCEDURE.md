...
HITL workflows can be initiated through several mechanisms:

#### **1. Task-Based HITL Escalation**
Tasks are automatically escalated to HITL based on predefined criteria:
