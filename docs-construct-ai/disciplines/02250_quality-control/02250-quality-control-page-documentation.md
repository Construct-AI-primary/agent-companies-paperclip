...
# 02250 - Quality Control Discipline Page Documentation

## Overview

This document details the structure and functionality of the Quality Control discipline page (02250). This page provides comprehensive quality control and inspection management capabilities with AI assistance for quality assurance, compliance monitoring, and inspection procedures.
...
- **Correspondence Reply** - Modal for quality control correspondence replies
...
- **Configuration**:
  - `pageId`: "02250"
  - `disciplineCode`: "QUALITY_CONTROL"
  - `title`: "Quality Control Assistant"
  - `welcomeTitle`: "Quality Control Center"
  - `welcomeMessage`: "I can help with quality assurance, inspection procedures, compliance monitoring, and quality management."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Container**: `A-02250-navigation-container`
...
- **Image Path**: `getThemedImagePath("02250.png")`
- **Styling**:
...
- **Path**: `client/src/pages/02250-quality-control/components/02250-quality-control-page.js`
...
- `quality-control-page` - Main page container
- `page-background` - Background styling
- `A-02250-navigation-container` - Navigation container
- `A-02250-nav-row` - State button row
- `state-button` - Individual state buttons
- `A-02250-button-container` - Modal button container
...
- Features specialized quality control and inspection management capabilities
