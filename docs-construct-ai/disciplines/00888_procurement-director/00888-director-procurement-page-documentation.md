...
# 00888 - Director Procurement Discipline Page Documentation

## Overview

This document details the structure and functionality of the Director Procurement discipline page (00888). This page provides executive-level procurement and supply chain oversight and management capabilities with AI assistance.
...
- **Correspondence Reply** - Modal for director-level procurement correspondence replies
...
- **Configuration**:
  - `pageId`: "00888"
  - `disciplineCode`: "DIRECTOR_PROCUREMENT"
  - `title`: "DIRECTOR PROCUREMENT Assistant"
  - `welcomeTitle`: "DIRECTOR PROCUREMENT Command Center"
  - `welcomeMessage`: "I can help you with director procurement processes and requirements."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Image Path**: `getThemedImagePath("00888.png")`
- **Styling**:
...
- **Document Title**: Dynamically set to "Director Procurement Page" using `document.title`
- **Implementation**: useEffect hook that runs once on component mount
- **Purpose**: Provides proper browser tab title for the director procurement page

### State Reset on Mount

- **Component State Reset**: State and visibility are reset when component mounts
- **Implementation**: useEffect hook that runs on mount with empty dependency array
- **Purpose**: Ensures clean state when navigating to the page
...
- **Document Access Button**: Uses `navigate()` to redirect to `/0165-ui-settings#document-access`
...
- **Path**: `client/src/pages/00888-director-procurement/components/00888-director-procurement-page.js`
...
- `director-procurement-page` - Main page container
- `page-background` - Background styling
- `A-00888-navigation-container` - Navigation container
- `A-00888-nav-row` - State button row
- `state-button` - Individual state buttons
- `page-button-container` - Modal button container
- `modal-trigger-button` - Individual modal buttons
- `logout-button` - Logout button styling
- `A-00888-logout-button` - Logout button
...
- **Mount Reset**: State reset on component mount for clean navigation
...
- Features executive-level procurement management capabilities
- Implements toggle-based state management for improved UX
- Includes proper component lifecycle management
