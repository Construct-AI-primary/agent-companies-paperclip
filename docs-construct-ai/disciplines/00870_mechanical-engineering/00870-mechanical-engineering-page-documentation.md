...
# 00870 - Mechanical Engineering Discipline Page Documentation

## Overview

This document details the structure and functionality of the Mechanical Engineering discipline page (00870). This page provides mechanical engineering capabilities with AI assistance for machinery design, HVAC systems, and mechanical infrastructure workflows.
...
- **Correspondence Reply** - Modal for mechanical engineering correspondence replies
...
- **Configuration**:
  - `pageId`: "00870"
  - `disciplineCode`: "MECHANICAL_ENGINEERING"
  - `title`: "MECHANICAL ENGINEERING Assistant"
  - `welcomeTitle`: "MECHANICAL ENGINEERING Command Center"
  - `welcomeMessage`: "I can help you with mechanical engineering processes and requirements."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Container**: `A-00870-navigation-container`
...
- **Image Path**: `getThemedImagePath("00870.png")`
- **Styling**:
...
- **Path**: `client/src/pages/00870-mechanical-engineering/components/00870-mechanical-engineering-page.js`
...
- `mechanical-engineering-page` - Main page container
- `page-background` - Background styling
- `epcm-mechanical-engineering` - Mechanical engineering specific styling
- `A-00870-navigation-container` - Navigation container
- `A-00870-nav-row` - State button row
...
- Features specialized mechanical engineering capabilities
