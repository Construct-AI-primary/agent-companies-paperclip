...
# 03000 - Landscaping Discipline Page Documentation

## Overview

This document details the structure and functionality of the Landscaping discipline page (03000). This page provides comprehensive landscaping and grounds management capabilities with AI assistance for landscape design, maintenance planning, and environmental coordination.
...
- **Correspondence Reply** - Modal for landscaping correspondence replies
...
- **Configuration**:
  ...
  - `welcomeTitle`: "LANDSCAPING Command Center"
  - `welcomeMessage`: "I can help you with landscaping processes and requirements."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Modal Buttons**: `A-03000-modal-trigger-button` class
...
- **Container**: `A-03000-navigation-container`
...
- **Image Path**: `getThemedImagePath("03000.png")`
- **Styling**:
...
- **Path**: `client/src/pages/03000-landscaping/components/03000-landscaping-page.js`
...
- `landscaping-page` - Main page container
- `page-background` - Background styling
- `A-03000-navigation-container` - Navigation container
- `A-03000-nav-row` - State button row
- `state-button` - Individual state buttons
- `A-03000-button-container` - Modal button container
- `A-03000-modal-trigger-button` - Individual modal buttons
...
- Features specialized landscaping and grounds management capabilities
