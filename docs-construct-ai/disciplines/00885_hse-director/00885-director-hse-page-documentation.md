...
# 00885 - Director HSE Discipline Page Documentation

## Overview

This document details the structure and functionality of the Director HSE discipline page (00885). This page provides executive-level Health, Safety, and Environment oversight and management capabilities with AI assistance.
...
- **Correspondence Reply** - Modal for director-level HSE correspondence replies
...
- **Configuration**:
  ...
  - `title`: "DIRECTOR HSE Assistant"
  - `welcomeTitle`: "DIRECTOR HSE Command Center"
  - `welcomeMessage`: "I can help you with director hse processes and requirements."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Modal Buttons**: `A-00885-modal-trigger-button` class
...
- **Container**: `A-00885-navigation-container`
...
- **Image Path**: `getThemedImagePath("00885.png")`
- **Styling**:
...
- **Path**: `client/src/pages/00885-director-hse/components/00885-director-hse-page.js`
...
- `director-hse-page` - Main page container
- `page-background` - Background styling
- `A-00885-navigation-container` - Navigation container
- `A-00885-nav-row` - State button row
- `state-button` - Individual state buttons
- `A-00885-button-container` - Modal button container
- `A-00885-modal-trigger-button` - Individual modal buttons
- `logout-button` - Logout button styling
- `A-00885-logout-button` - Logout button
...
- Features executive-level HSE management capabilities
