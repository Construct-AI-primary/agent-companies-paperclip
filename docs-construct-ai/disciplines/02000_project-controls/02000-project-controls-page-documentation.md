...
# 02000 - Project Controls Discipline Page Documentation

## Overview

This document details the structure and functionality of the Project Controls discipline page (02000). This page provides comprehensive project controls capabilities with AI assistance for cost management, schedule tracking, project documentation, and performance monitoring.
...
- **Correspondence Reply** - Modal for project controls correspondence replies
...
- **Configuration**:
  - `pageId`: "02000"
  - `disciplineCode`: "PROJECT_CONTROLS"
  - `title`: "Project Controls Assistant"
  - `welcomeTitle`: "Project Controls Command Center"
  - `welcomeMessage`: "I can help you with project controls processes, cost management, schedule tracking, and project documentation. Ask me anything about project control workflows and requirements."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Modal Buttons**: `A-02000-modal-trigger-button` class
...
- **Container**: `A-02000-navigation-container`
...
- **Image Path**: `getThemedImagePath("02000.png", "mining")`
...
- **Path**: `client/src/pages/02000-project-controls/components/02000-project-controls-page.js`
...
- Contractor vetting: `ContractorVettingPageComponent` integration

### CSS Classes Used

- `project-controls-page` - Main page container
- `page-background` - Background styling
- `A-02000-navigation-container` - Navigation container
- `A-02000-nav-row` - State button row
- `state-button` - Individual state buttons
- `A-02000-button-container` - Modal button container
- `A-02000-modal-trigger-button` - Individual modal buttons
...
- Features specialized project controls and management capabilities
- Integrates contractor vetting component for department access
