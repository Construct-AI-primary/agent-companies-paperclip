...
# 01000 - Environmental Discipline Page Documentation

## Overview

This document details the structure and functionality of the Environmental discipline page (01000). This page provides environmental compliance and management capabilities with AI assistance for regulatory compliance, impact assessments, and sustainability initiatives.
...
- **Correspondence Reply** - Modal for environmental correspondence replies
...
- **Configuration**:
  - `pageId`: "01000"
  - `disciplineCode`: "ENVIRONMENTAL"
  - `title`: "Environmental Assistant"
  - `welcomeTitle`: "Environmental Command Center"
  - `welcomeMessage`: "environmental compliance management with AI"
- **Features Enabled**:
  - Citations
  - Document count
...
- **Container**: `A-01000-navigation-container`
...
- **Image Path**: `getThemedImagePath("01000.png", "mining")`
...
- **Path**: `client/src/pages/01000-environmental/components/01000-environmental-page.js`
...
- `environmental-page` - Main page container
- `page-background` - Background styling
- `A-01000-navigation-container` - Navigation container
- `A-01000-nav-row` - State button row
...
- Features specialized environmental compliance capabilities
