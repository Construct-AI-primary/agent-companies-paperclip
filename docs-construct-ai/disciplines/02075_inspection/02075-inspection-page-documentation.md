...
# 02075 - Inspection Discipline Page Documentation

## Overview

This document details the structure and functionality of the Inspection discipline page (02075). This page provides comprehensive inspection and compliance monitoring capabilities with AI assistance for safety inspections, quality control, and regulatory compliance workflows.
...
- **Correspondence Reply** - Modal for inspection correspondence replies
...
- **Configuration**:
  - `pageId`: "02075"
  - `disciplineCode`: "INSPECTION"
  - `title`: "INSPECTION Assistant"
  - `welcomeTitle`: "INSPECTION Command Center"
  - `welcomeMessage`: "I can help you with inspection processes and requirements."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Modal Buttons**: `A-02075-modal-trigger-button` class
...
- **Image Path**: `getThemedImagePath("02075.png")`
- **Styling**:
...
- **Path**: `client/src/pages/02075-inspection/components/02075-inspection-page.js`
...
- `inspection-page` - Main page container
- `page-background` - Background styling
- `A-02075-nav-row` - State button row
- `state-button` - Individual state buttons
- `A-02075-button-container` - Modal button container
- `A-02075-modal-trigger-button` - Individual modal buttons
...
- Features specialized inspection and compliance monitoring capabilities
