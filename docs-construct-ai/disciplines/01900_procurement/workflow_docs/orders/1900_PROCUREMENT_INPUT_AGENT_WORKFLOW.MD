---
title: 01900 Procurement Input Agent Workflow Procedure
...
**UI Pattern:** Card/Button Selection (Multi-select enabled)
...
├─────────────────────────────────────────┤
│ Industrial Services/Subcontracting      │
├─────────────────────────────────────────┤
│ Production Subcontracting               │
└─────────────────────────────────────────┘
```

**User Action:** Click card(s) to select (supports multiple selections)

**Transition:** On selection → Show Level 2 categories for selected Group(s)
...
│ Chemical Products                       │
├─────────────────────────────────────────┤
│ Refractory Products & Insulators        │
└─────────────────────────────────────────┘
```

**User Action:** Click card(s) to select (supports multiple selections)

**Transition:** On selection → Show Level 3 items for selected Category(ies)
...
**UI Pattern:** Card/Button Selection (Single-select)
...
**User Action:** Click card to select urgency level

**Transition:** On selection → Proceed to Stage 5 or Stage 7
