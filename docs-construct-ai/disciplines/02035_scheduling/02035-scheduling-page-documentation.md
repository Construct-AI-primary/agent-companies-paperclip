...
# 02035 - Scheduling Discipline Page Documentation

## Overview

This document details the structure and functionality of the Scheduling discipline page (02035). This page provides comprehensive scheduling and project timeline management capabilities with AI assistance for project planning, milestone tracking, and schedule optimization.
...
- **Correspondence Reply** - Modal for scheduling correspondence replies
...
- **Configuration**:
  - `pageId`: "02035"
  - `disciplineCode`: "SCHEDULING"
  - `title`: "Scheduling Assistant"
  - `welcomeTitle`: "Scheduling Command Center"
  - `welcomeMessage`: "I can help you with scheduling processes and requirements."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Container**: `A-02035-navigation-container`
...
- **Image Path**: `getThemedImagePath("02035.png")`
- **Styling**:
...
- **Path**: `client/src/pages/02035-scheduling/components/02035-scheduling-page.js`
...
- `scheduling-page` - Main page container
- `page-background` - Background styling
- `A-02035-navigation-container` - Navigation container
- `A-02035-nav-row` - State button row
- `state-button` - Individual state buttons
- `A-02035-button-container` - Modal button container
...
- Features specialized scheduling and project timeline management capabilities
