...
# 00882 - Director Construction Discipline Page Documentation

## Overview

This document details the structure and functionality of the Director Construction discipline page (00882). This page provides executive-level construction oversight and management capabilities with AI assistance.
...
- **Correspondence Reply** - Modal for director-level construction correspondence replies
...
- **Configuration**:
  - `pageId`: "00882"
  - `disciplineCode`: "DIRECTOR_CONSTRUCTION"
  - `title`: "Director Construction Assistant"
  - `welcomeTitle`: "Director Construction Command Center"
  - `welcomeMessage`: "construction director oversight with AI"
- **Features Enabled**:
  - Citations
  - Document count
...
- **Container**: `A-00882-navigation-container`
...
- **Image Path**: `getThemedImagePath("00882.png", "mining")`
- **Styling**:
...
- **Path**: `client/src/pages/00882-director-construction/components/00882-director-construction-page.js`
...
- `director-construction-page` - Main page container
- `page-background` - Background styling
- `A-00882-navigation-container` - Navigation container
- `A-00882-nav-row` - State button row
- `state-button` - Individual state buttons
- `A-00882-button-container` - Modal button container
...
- Features executive-level construction management capabilities
