...
# 00860 - Electrical Engineering Discipline Page Documentation

## Overview

This document details the structure and functionality of the Electrical Engineering discipline page (00860). This page provides electrical engineering capabilities with AI assistance for power systems, electrical design, and infrastructure workflows.
...
- **Correspondence Reply** - Modal for electrical engineering correspondence replies
...
- **Configuration**:
  - `pageId`: "00860"
  - `disciplineCode`: "ELECTRICAL_ENGINEERING"
  - `title`: "ELECTRICAL ENGINEERING Assistant"
  - `welcomeTitle`: "ELECTRICAL ENGINEERING Command Center"
  - `welcomeMessage`: "I can help you with electrical engineering processes and requirements."
- **Features Enabled**:
  - Citations
  - Document count
...
- **Container**: `A-00860-navigation-container`
...
- **Image Path**: `getThemedImagePath("00860.png")`
- **Styling**:
...
- **Path**: `client/src/pages/00860-electrical-engineering/components/00860-electrical-engineering-page.js`
...
- `electrical-engineering-page` - Main page container
- `page-background` - Background styling
- `epcm-electrical-engineering` - Electrical engineering specific styling
- `A-00860-navigation-container` - Navigation container
- `A-00860-nav-row` - State button row
...
- Features specialized electrical engineering capabilities
