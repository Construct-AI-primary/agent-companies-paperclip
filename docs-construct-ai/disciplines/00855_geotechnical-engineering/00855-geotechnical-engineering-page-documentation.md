...
# 00855 - Geotechnical Engineering Discipline Page Documentation

## Overview

This document details the structure and functionality of the Geotechnical Engineering discipline page (00855). This page provides geotechnical engineering capabilities with AI assistance for soil mechanics, foundation analysis, and ground engineering workflows.
...
- **Correspondence Reply** - Modal for geotechnical engineering correspondence replies
...
- **Configuration**:
  - `pageId`: "00855"
  - `disciplineCode`: "GEOTECHNICAL_ENGINEERING"
  - `title`: "GEOTECHNICAL ENGINEERING Assistant"
  - `welcomeTitle`: "GEOTECHNICAL ENGINEERING Command Center"
  - `welcomeMessage`: "I can help you with geotechnical engineering processes and requirements."
- **Features Enabled**:
  - Citations
  - Document count
  - Conversation history
- **Theme**: Brown color scheme (primary: #8B4513, secondary: #A0522D)
- **Note**: Uses brown theme instead of standard orange, indicating specialized geotechnical focus
...
- **Container**: `A-00855-navigation-container`
...
- **Image Path**: `getThemedImagePath("00855.png")`
- **Styling**:
...
- **Path**: `client/src/pages/00855-geotechnical-engineering/components/00855-geotechnical-engineering-page.js`
...
- `geotechnical-engineering-page` - Main page container
- `page-background` - Background styling
- `A-00855-navigation-container` - Navigation container
- `A-00855-nav-row` - State button row
...
- Features specialized geotechnical engineering capabilities
- Uses distinct brown color theme for geotechnical specialization
