...
# 00895 - Director Project Discipline Page Documentation

## Overview

This document details the structure and functionality of the Director Project discipline page (00895). This page provides executive-level project management and oversight capabilities with AI assistance for project coordination, risk management, and stakeholder communication.
...
- **Correspondence Reply** - Modal for director-level project correspondence replies
...
- **Configuration**:
  - `pageId`: "00895"
  - `disciplineCode`: "DIRECTOR_PROJECT"
  - `title`: "Director Project Assistant"
  - `welcomeTitle`: "Director Project Command Center"
  - `welcomeMessage`: "Project director oversight with AI"
- **Features Enabled**:
  - Citations
  - Document count
...
- **Modal Buttons**: `A-00895-modal-trigger-button` class
...
- **Container**: `A-00895-navigation-container`
...
- **Image Path**: `getThemedImagePath("00895.png", "mining")`
...
- **Path**: `client/src/pages/00895-director-project/components/00895-director-project-page.js`
...
- `director-project-page` - Main page container
- `page-background` - Background styling
- `A-00895-navigation-container` - Navigation container
- `A-00895-nav-row` - State button row
- `state-button` - Individual state buttons
- `A-00895-button-container` - Modal button container
- `A-00895-modal-trigger-button` - Individual modal buttons
...
- Features executive-level project management capabilities
